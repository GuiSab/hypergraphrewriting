...
main = do
    ...
    putStrLn $ "\n\n\n"
    putStrLn $ show $ partialPermutations (set [1,2,3]) 2
    putStrLn $ show $ partialPermutations (set [1,2,3]) 3
    putStrLn $ show $ cardinal <$> partialPermutations (set [1,2,3,4,5,6]) <$> [1..6]
    
    putStrLn $ show $ combinations (set [1,2,3,4]) 2
    putStrLn $ show $ cardinal <$> combinations (set [1,2,3,4,5,6]) <$> [1..6]
    putStrLn $ "\n\n\n\n"
    
    putStrLn $ show $ cardinal $ enumerateKMatchingOnBipartiteCompleteGraph (set [1,2,3]) (set "abc") 1
    putStrLn $ show $ cardinal $ enumerateKMatchingOnBipartiteCompleteGraph (set [1,2,3]) (set "abc") 2
    putStrLn $ show $ cardinal $ enumerateKMatchingOnBipartiteCompleteGraph (set [1,2,3]) (set "abc") 3
    putStrLn $ show $ cardinal $ enumerateKMatchingOnBipartiteCompleteGraph (set [1,2,3]) (set "abc") 4
    
    
    putStrLn $ "\n\n\n\n\n"
    putStrLn $ show $ enumerateMatchingOnBipartiteCompleteGraph (set [1,2,3]) (set "abc")
    putStrLn $ show $ cardinal $ enumerateMatchingOnBipartiteCompleteGraph (set [1,2,3]) (set "abc")
    ...
    putStrLn $ show $  precriticalpairs
